...
export const MobileGrowthLab: React.FC<MobileGrowthLabProps> = ({
  ...
  return (
    <div className="space-y-3 pb-20 animate-in fade-in duration-300 select-none">
      ...
      <div className="bg-slate-900/95 border border-slate-800 rounded-3xl p-3.5 shadow-lg space-y-2.5">
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-center text-[11px] font-bold">
            ...
            <span className="text-xs font-black text-white font-mono bg-slate-950 px-2 py-0.5 rounded-lg border border-slate-800">
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-center text-[11px] font-bold">
            ...
            <span className="text-[10px] font-black text-amber-400 font-mono bg-amber-950/60 px-2 py-0.5 rounded-lg border border-amber-600/40">
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-center text-[11px] font-bold">
            <span className="text-slate-300">Parent Compounding Yield (p.a.)</span>
            <span className="text-[10px] font-black text-emerald-400 font-mono bg-emerald-950/60 px-2 py-0.5 rounded-lg border border-emerald-600/40">
      ...
      <div className="bg-gradient-to-br from-indigo-950 via-slate-900 to-purple-950 border border-indigo-500/40 rounded-3xl p-3.5 shadow-xl space-y-2.5">
        <div className="flex justify-between items-center">
          <div>
            <span className="text-[10px] font-bold uppercase text-slate-400 block">Total Projected Snowball</span>
          ...
          <div className="text-right">
            <span className="text-[10px] font-bold text-amber-300 block">Net Gains</span>
